...
export const FAQSection = () => {
  ...
  return (
    <section id="faq" className="relative py-16 sm:py-20 lg:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto space-y-2 sm:space-y-3">
          {faqs.map((faq, index) => (
            <div key={index} className="glass-card overflow-hidden">
              ...
              {/* SEO-safe: content always in DOM, visually hidden when closed */}
              <div
        ...
        <div className="glass-card p-6 sm:p-8 mt-8 sm:mt-12 max-w-3xl mx-auto text-center">
          <p className="text-base sm:text-lg font-medium mb-4">Vous avez encore une question ?</p>
