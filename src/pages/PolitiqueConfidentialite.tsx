      ...
      <section className="py-10 sm:py-16 lg:py-24">
        <div className="container mx-auto px-5 sm:px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Introduction */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Introduction</h2>
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Responsable du traitement</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Le responsable du traitement des données personnelles est :
              </p>
              <ul className="list-none text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2">
            ...
            {/* Données collectées */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Données personnelles collectées</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Dans le cadre de l'utilisation de notre service, nous collectons les catégories de données suivantes :
              </p>

              <h3 className="text-base sm:text-xl font-semibold mb-3">Données d'identification et de compte</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-4">
                <li>Adresse email</li>
                <li>Mot de passe (stocké sous forme chiffrée)</li>
                <li>Informations de profil (nom, prénom, entreprise)</li>
              </ul>

              <h3 className="text-base sm:text-xl font-semibold mb-3">Données métier</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">Données de paiement</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">Données de navigation et techniques</h3>
            ...
            {/* Finalités */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Finalités du traitement</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Base légale */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Base légale du traitement</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Destinataires */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Destinataires des données</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Hébergement */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Hébergement et transfert des données</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Conservation */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Durée de conservation</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Cookies */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Cookies et technologies similaires</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">Outils d'analyse utilisés</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-4">
            ...
            {/* Sécurité */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Sécurité des données</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Droits */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Vos droits</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Modification */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Modification de la politique</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Contact</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
