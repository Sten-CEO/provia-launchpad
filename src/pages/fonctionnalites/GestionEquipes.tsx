        ...
        <div className="container mx-auto px-5 sm:px-4 lg:px-8 relative z-10 max-sm:pt-20">
          ...
          <div className="sm:hidden text-center space-y-5 animate-fade-in mt-4">
            ...
            <p className="text-xs text-muted-foreground flex flex-wrap items-center justify-center gap-3">
              ...
              <span className="flex items-center gap-1"><Check className="w-3 h-3 text-provia-teal" /> App mobile incluse</span>
            </p>
          </div>
          ...
          <div className="hidden sm:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 animate-fade-in">
              <span className="inline-block text-primary font-medium text-lg">Fonctionnalité Gestion équipes</span>
