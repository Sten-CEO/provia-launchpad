        ...
        <div className="container mx-auto px-5 sm:px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Éditeur du site</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Le site <strong>proviabase.fr</strong> et le service <strong>Provia BASE</strong> sont édités par :
              </p>
              <ul className="list-none text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-6">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Directeur de la publication</h2>
            ...
            {/* Hébergement */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Hébergement</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                Le site et l'application sont hébergés par :
              </p>
              <h3 className="text-base sm:text-xl font-semibold mb-3">Site web et application</h3>
              <ul className="list-none text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2 mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">Base de données et authentification</h3>
              <ul className="list-none text-sm sm:text-base text-muted-foreground space-y-1.5 sm:space-y-2">
            ...
            {/* Nature du service */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Nature du service</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Propriété intellectuelle</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Protection des données personnelles</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Cookies */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Cookies et traceurs</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Responsabilité */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Limitation de responsabilité</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Droit applicable */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Droit applicable et juridiction compétente</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
