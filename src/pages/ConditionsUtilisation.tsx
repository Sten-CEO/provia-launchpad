        ...
        <div className="container mx-auto px-5 sm:px-4 lg:px-8">
          <div className="max-w-4xl mx-auto prose prose-gray dark:prose-invert">
            ...
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Préambule</h2>
            ...
            {/* Article 1 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 1 – Description du service</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 2 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 2 – Inscription et compte utilisateur</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 3 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 3 – Abonnements et paiements</h2>
              <h3 className="text-base sm:text-xl font-semibold mb-3">3.1 Formules d'abonnement</h3>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">3.2 Paiement</h3>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">3.3 Résiliation</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
            ...
            {/* Article 4 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 4 – Obligations de l'utilisateur</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 5 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 5 – Propriété intellectuelle</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 6 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 6 – Responsabilité</h2>
              <h3 className="text-base sm:text-xl font-semibold mb-3">6.1 Limitation de responsabilité</h3>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
              ...
              <h3 className="text-base sm:text-xl font-semibold mb-3">6.2 Responsabilité de l'utilisateur</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
            ...
            {/* Article 7 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 7 – Protection des données</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 8 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 8 – Modification des CGU</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 9 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 9 – Droit applicable et litiges</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
            ...
            {/* Article 10 */}
            <div className="glass-card p-4 sm:p-6 lg:p-8 mb-5 sm:mb-8">
              <h2 className="text-lg sm:text-2xl font-bold mb-4">Article 10 – Contact</h2>
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
